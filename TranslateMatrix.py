...
class window(QMainWindow):
    def __init__(self):
        ...
        DrawScreen.set_screen(self)


    # def open_chrome_window(self):
    #     self.driver = webdriver.Chrome(executable_path = GlobalVariables.google_executable_path) # , options = chrome_options
    ...
    #     self.combo_box_mode.addItems(GlobalVariables.ocr_mode_list)
    ...
    #     self.retranslate_btn.setText(GlobalVariables.retranslate_btn_txt)
    #     self.retranslate_btn.setGeometry(GlobalVariables.retranslate_btn_loc_X, GlobalVariables.retranslate_btn_loc_Y, GlobalVariables.button_width, GlobalVariables.button_height)
    ...
    #     self.pre_translate_image_viewer.setGeometry(GlobalVariables.pre_translate_image_viewer_loc_X, GlobalVariables.pre_translate_image_viewer_loc_Y, GlobalVariables.pre_translate_image_viewer_width, GlobalVariables.pre_translate_image_viewer_height)

    #     # =============== Post Translate Image Viewer =============== #
    #     self.post_translate_image_viewer = PhotoViewer(self)
    #     self.post_translate_image_viewer.setGeometry(GlobalVariables.post_translate_image_viewer_loc_X, GlobalVariables.post_translate_image_viewer_loc_Y, GlobalVariables.post_translate_image_viewer_width, GlobalVariables.post_translate_image_viewer_height)

    #     # =============== Iteration Combo Box =============== #
    #     self.iteration_combo_box = QtWidgets.QComboBox(self)
    #     self.iteration_combo_box.addItems(GlobalVariables.iteration_list)
    #     self.iteration_combo_box.setGeometry(GlobalVariables.combo_box_iteration_loc_X, GlobalVariables.combo_box_iteration_loc_Y, GlobalVariables.combo_box_iteration_width, GlobalVariables.combo_box_iteration_height)
    #     self.iteration_combo_box.setCurrentIndex(4)

    #     # =============== Run Option Combo Box =============== #
    #     self.run_option_combo_box = QtWidgets.QComboBox(self)
    #     self.run_option_combo_box.addItems(GlobalVariables.run_option_list)
    #     self.run_option_combo_box.setGeometry(GlobalVariables.combo_box_run_option_loc_X, GlobalVariables.combo_box_run_option_loc_Y, GlobalVariables.combo_box_run_option_width, GlobalVariables.combo_box_run_option_height)

    #     # =============== Show Image Check Box =============== #
    #     self.show_image_check_box = QtWidgets.QCheckBox(self)
    #     self.show_image_check_box.move(GlobalVariables.check_box_show_image_loc_X, GlobalVariables.check_box_show_image_loc_Y)
    #     self.show_image_check_box.setText(GlobalVariables.check_box_show_image_text)
    ...
    #     try:
    #         ProcessImage.process_image(self, GlobalVariables.duplicated_pic_path)
